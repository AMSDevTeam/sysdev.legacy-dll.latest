...
#Region "Methods"
    Private Sub PictureBoxToCenter()
        'Dim pctlocation As Point = New Point((Size.Width / 2) - (pctLoad.Size.Width / 2),
        ...
        'lblLoading.Location = pctlocation
        Dim pctlocation As Point = New Point(((Size.Width / 2) - (pctLoad.Size.Width / 2)) - 10,
                                             (Size.Height / 2) - (pctLoad.Size.Height / 2) - 14)
        grpBox.Location = pctlocation
...
#Region "Events"
    ...
    Private Sub LoadingForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Select Case LoadScreen.LoadingImage
            ...
            Case Else
                pctLoad.Image = pctBlack.Image
        End Select

        'ShowInTaskbar = IsDialog : ShowIcon = IsDialog
        Me.Size = New Size(97, 84)
        Opacity = 0.54
        ...
        For Each frm As Form In Application.OpenForms
            If frm.Name.In("frmMain", "frmMain".ToLower, "frmMain".ToProper,
